...
async function initRbac() {
    try {
        ...
        // 5. Assign 'Administrator' Role to existing Admin User
        ...
        if (userRes.rows.length > 0) {
            ...
            console.log(`Assigned Administrator role to user ${adminEmail}`);
        } else {
            console.log(`Warning: User ${adminEmail} not found. Run seed_admin.js first if needed.`);
        }
